        ...
        <div>
            <div className="pt-16 pb-8 relative">
                ...
                <div className="max-w-[70%] container mx-auto flex gap-5 mt-10 justify-center" >
                 <input className="border bg-white w-[30%] text-xl px-6 py-4 rounded-2xl" placeholder="Delhi, India"></input>
                 <input className="border bg-white w-[45%] text-xl px-6 py-4 rounded-2xl" placeholder="Search for restaurant and items for more"></input>
                </div>
            </div>
        </div>
